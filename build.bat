...
cl %CommonCompilerFlags% /I "..\SlopEngine\engine" /I "..\SlopEngine\windows_platform" /I "..\SlopEngine\SDL3\include" "..\SlopEngine\windows_platform\win32_handmade.cpp" -Fewin32_handmade.exe -Fmwin32_handmade.map /link %CommonLinkerFlags% /LIBPATH:"..\SlopEngine\SDL3\lib\x64" SDL3.lib
