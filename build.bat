...
REM Game DLL
cl %CommonCompilerFlags% /I "..\SlopEngine\engine" "..\SlopEngine\engine\handmade.cpp" -Fmhandmade.map /link /DLL /EXPORT:GameGetSoundSamples /EXPORT:GameUpdateAndRender
