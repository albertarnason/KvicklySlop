...
COMMON_FLAGS="-std=c++23 -Wall -Wextra -Werror -Wshadow -Wconversion -Wsign-conversion -Wundef -Wstrict-aliasing -Wformat=2 -Wmissing-declarations -fno-exceptions -fno-rtti -I SlopEngine/engine"
...
g++ SlopEngine/linux_platform/linux_handmade_sdl.cpp -o build/handmade $COMMON_FLAGS $BUILD_FLAGS $PLATFORM_FLAGS
